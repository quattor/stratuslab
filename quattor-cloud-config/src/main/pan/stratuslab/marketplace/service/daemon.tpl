...
unique template stratuslab/marketplace/service/daemon;

include { 'stratuslab/marketplace/rpms/'+STRATUSLAB_SPMA_VERSION+'/daemon' };

include { 'stratuslab/marketplace/variables' };

include { 'stratuslab/marketplace/service/mysql' };
#
...
'/software/components/filecopy/services/{/etc/stratuslab/marketplace.cfg}' = 
  nlist('config',format(file_contents('stratuslab/marketplace/service/daemon.cfg'),
