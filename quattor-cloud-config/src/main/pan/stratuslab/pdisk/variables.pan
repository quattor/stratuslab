...
variable STRATUSLAB_PDISK_DISCONNECT        ?= 'true';
...
variable STRATUSLAB_PDISK_PATH             ?= '/pdisk';
variable STRATUSLAB_PDISK_PORT             ?= '443';
variable STRATUSLAB_PDISK_PUBLIC_BASE_URL  ?= "https://"+STRATUSLAB_PDISK_HOST+":"+STRATUSLAB_PDISK_PORT;
