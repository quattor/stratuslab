...
include { 'stratuslab/pdisk/rpms/'+STRATUSLAB_SPMA_VERSION+'/host' };
...
#
# Include iscsi-initiator if iscsi pdisk backend is used
#
include {
  if ( STRATUSLAB_PDISK_BACKEND_TYPE == "iscsi" ) {
    'common/iscsi/rpms/'+STRATUSLAB_SPMA_VERSION+'/initiator';
} else {
    null;
  };
};
