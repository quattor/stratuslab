...
"/software/packages"=pkg_repl("perl-Net-DNS","0.65-2.el6","x86_64");
...
'/software/packages'=pkg_repl('boost','1.41.0-11.el6',PKG_ARCH_GLITE);
'/software/packages'=pkg_repl('expat','2.0.1-9.1.el6',PKG_ARCH_GLITE);
'/software/packages'=pkg_repl('libstdc++','4.4.5-6.el6',PKG_ARCH_GLITE);
...
'/software/packages' = pkg_repl('tkinter','2.6.6-20.el6', PKG_ARCH_DEFAULT);
...
'/software/packages'=pkg_repl('libgcj','4.4.5-6.el6',PKG_ARCH_DEFAULT);
'/software/packages'=pkg_repl('libgcj-devel','4.4.5-6.el6',PKG_ARCH_DEFAULT);
