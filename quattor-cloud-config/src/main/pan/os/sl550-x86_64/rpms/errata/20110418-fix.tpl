...
'/software/packages' = if (exists(SELF[escape('python')])) {
    pkg_add('python-libs','2.4.3-43.el5','x86_64');
} else {
    SELF;
};
...
'/software/packages' = if ( exists(SELF['libvirt']) ) {
    pkg_add('ebtables','2.0.9-5.el5','x86_64');
    pkg_add('xz','4.999.9-0.3.beta.20091007git.el5','x86_64');
    pkg_add('xz-libs','4.999.9-0.3.beta.20091007git.el5','x86_64');
} else {
    SELF;
};
