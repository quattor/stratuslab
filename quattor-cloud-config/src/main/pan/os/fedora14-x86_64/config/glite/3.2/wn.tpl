...
'/software/packages' = pkg_repl('lapack','3.0-37.el5','i686');
'/software/packages' = pkg_repl('pcre','6.6-2.el5_1.7','i686');
'/software/packages' = pkg_repl('boost','1.41.0-11.el6','i686');
'/software/packages' = pkg_repl('boost-devel','1.41.0-11.el6','i686');
'/software/packages' = pkg_repl('libicu','3.6-5.11.4','i686');
...
# Atlas Requirements
'/software/packages' = pkg_repl('libxml2','2.6.26-2.1.2.8','i686');
'/software/packages' = pkg_repl('libxml2-devel','2.6.26-2.1.2.8','i686');
'/software/packages' = pkg_repl('libxml2','2.6.26-2.1.2.8','x86_64');
'/software/packages' = pkg_repl('libxml2-devel','2.6.26-2.1.2.8','x86_64');
'/software/packages' = pkg_repl('blas','3.0-37.el5','i686');
'/software/packages' = pkg_repl('blas-devel','3.0-37.el5','i686');
'/software/packages' = pkg_repl('blas','3.0-37.el5','x86_64');
'/software/packages' = pkg_repl('blas-devel','3.0-37.el5','x86_64');

# Blas dependencies
'/software/packages'=pkg_repl('libgfortran','4.1.2-48.el5','i686');
